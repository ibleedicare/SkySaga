...
public static class Util
{
    ...
    public static uint ComputeCrc32(string value, uint initialValue = 0u, int lengthLimit = int.MaxValue)
    {
    ...
    public static uint ComputeCrc32(byte[] value, uint initialValue = 0u, int lengthLimit = int.MaxValue)
    {
    ...
    public static uint NumBitsRequiredUInt32(uint max)
    {
        var required = 32u;
